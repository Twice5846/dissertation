...
To expand knowledge, we must first define what knowledge is.

That is, what can and what can not be known.

The expansion of knowledge -- the aim of any scientific endeavor -- requires a prior definition of the concept of knowledge.

How, though, can we know what knowledge is?

To pose a research question, we must first distinguish the space of sensical answers from the non-sensical and senseless answers.
To configure and execute a research method, we must first 
